...
const movies = [
  ...
  mongoose
  .connect("mongodb://127.0.0.1:27017/lab-express-cinema", { bufferCommands: false })
  .then(() => {
    ...
    const seedDatabase = async () => {
      try {
        ...
        console.log("Datos de películas insertados en la base de datos.");
      } catch (error) {
        console.error("Error al insertar los datos de películas:", error);
      } finally {
